...
static void gclk0_init (void) {
    ...
    while(!((GCLK_REGS->GCLK_GENCTRL[0] & GCLK_GENCTRL_SRC_Msk) == GCLK_GENCTRL_SRC_OSC48M_Val));
}
...
static void mclk_init (void) {
   ...
   // Enable AHB (High-Speed Bus) Clocks
    MCLK_REGS->MCLK_AHBMASK = MCLK_AHBMASK_NVMCTRL_Msk | MCLK_AHBMASK_DSU_Msk;
    ...
    MCLK_REGS->MCLK_APBAMASK = MCLK_APBAMASK_MCLK_Msk |   // Main Clock
                           ...
                           MCLK_APBAMASK_OSC32KCTRL_Msk | // 32KHz Oscillator
