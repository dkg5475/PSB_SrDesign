...
static void mclk_init (void) {
    ...
    MCLK_REGS->MCLK_APBCMASK = MCLK_APBCMASK_SERCOM0_Msk | // UART
                           ...
                           MCLK_APBCMASK_TC3_Msk |      // Timer/Counter 3
                           MCLK_APBCMASK_TC2_Msk |      // Timer/Counter 2
                           MCLK_APBCMASK_EVSYS_Msk;     //Event System 
...
static void peripheral_clk_init (void) {
    ...
    // Set the TC2 instance to run off GCLK0 
    GCLK_REGS->GCLK_PCHCTRL[TC2_GCLK_ID] = GCLK_PCHCTRL_GEN_GCLK0 | GCLK_PCHCTRL_CHEN_Msk;
    //wait for sync
    while ((GCLK_REGS->GCLK_PCHCTRL[TC2_GCLK_ID] & GCLK_PCHCTRL_CHEN_Msk) != GCLK_PCHCTRL_CHEN_Msk);
